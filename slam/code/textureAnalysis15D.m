function [params] = textureAnalysis15D(im0, Nsc, Nor, Na)

% Analyze texture for application of 1.5D modification of the
% Portilla-Simoncelli model/algorithm.
%
% [params] = textureAnalysis15D(im0, Nsc, Nor, Na);
% 	im0: 	original image
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Computing the horizontal statistics.
% -fcole May 17 2010

horMeans0 = mean(im0, 2);
horVars0 = var(im0, 1, 2);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Adding horizontal statistics to pass to textureSynthesis15D
% -fcole May 17 2010
params = struct(...
        'horMeans0', horMeans0, ...
        'horVars0', horVars0, ...
